...
<section class="home">
    ...
    <div class="category-section">
        ...
        <div class="product-grid">
            <div class="product-card">
                <img src="{{ asset('images/kaos-placeholder.jpg') }}" alt="Kaos" class="product-image">
    ...
    <div class="category-section">
        ...
        <div class="product-grid">
            <div class="product-card">
                <img src="{{ asset('images/kemeja-placeholder.jpg') }}" alt="Kemeja" class="product-image">
    ...
    <div class="category-section">
        ...
        <div class="product-grid">
            <div class="product-card">
                <img src="{{ asset('images/sport-placeholder.jpg') }}" alt="Baju Olahraga" class="product-image">
    ...
    <div class="category-section">
        ...
        <div class="product-grid">
            <div class="product-card">
                <img src="{{ asset('images/jaket-placeholder.jpg') }}" alt="Jaket" class="product-image">
