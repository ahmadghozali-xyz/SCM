...
<section class="home">
    ...
    <div class="report-section">
        ...
        <div class="report-grid">
            ...
            <div class="report-card">
                <h4>{{ ucfirst($bahan->kategori) }}</h4>
                <div class="category-total">
                    <span>Total Stok:</span>
                    <span>{{ $bahan->total_stok }} unit</span>
                </div>
                <div class="category-total">
                    <span>Total Nilai:</span>
                    <span>Rp {{ number_format($bahan->total_nilai, 0, ',', '.') }}</span>
                </div>
            </div>
            @endforeach
        </div>
    ...
    <div class="report-section">
        ...
        <div class="report-grid">
            ...
            <div class="report-card">
                <h4>{{ ucfirst($produk->kategori) }}</h4>
                <div class="category-total">
                    <span>Total Pesanan:</span>
                    <span>{{ $produk->total_pesanan }} unit</span>
                </div>
                <div class="category-total">
                    <span>Total Pendapatan:</span>
                    <span>Rp {{ number_format($produk->total_pendapatan, 0, ',', '.') }}</span>
                </div>
            </div>
            @endforeach
        </div>
    ...
    <div class="report-section">
        ...
        <div class="total-section">
            <div class="category-total">
                ...
                <span class="total-amount">Rp {{ number_format($totalPengeluaran, 0, ',', '.') }}</span>
            </div>
        </div>
    </div>
</section>
