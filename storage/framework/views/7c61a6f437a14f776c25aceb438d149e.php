...
<div class="login-container rounded-lg shadow-lg p-10 w-96">
    ...
    <div id="registerForm" class="hidden mt-6">
        ...
        <form action="<?php echo e(url('/register')); ?>" method="POST"> <!-- Pastikan action mengarah ke rute registrasi -->
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\utsframework\resources\views/welcome.blade.php ENDPATH**/ ?>