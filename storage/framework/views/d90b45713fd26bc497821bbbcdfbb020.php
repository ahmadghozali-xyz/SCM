...
<section class="home">
    ...
    <table>
      ...
      <tbody>
          <?php $__currentLoopData = $dataStok; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bahan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                  <td><?php echo e($bahan->id); ?></td> 
                  <td><?php echo e($bahan->nama_bahan); ?></td> 
                  <td><?php echo e($bahan->kategori); ?></td> 
                  <td><?php echo e($bahan->jumlah); ?></td> 
                  <td><?php echo e($bahan->pemasok); ?></td> 
                  <td><?php echo e(number_format($bahan->harga, 2, ',', '.')); ?></td> <!-- Format harga -->
              </tr> 
...
<?php /**PATH C:\laragon\www\utsframework\resources\views/stok.blade.php ENDPATH**/ ?>